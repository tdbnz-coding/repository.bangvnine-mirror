...
class Button(CompareMixin, xbmcgui.ControlButton):
    """
    Button(label, focusTexture=None, noFocusTexture=None, textOffsetX=CONTROL_TEXT_OFFSET_X, textOffsetY=CONTROL_TEXT_OFFSET_Y, alignment=4, font=None, textColor=None, disabledColor=None, angle=0, thechainsColor=None, focusedColor=None)
    ...
    :param angle: angle of control. (``+`` rotates CCW, ``-`` rotates CW)
    :type angle: int
    :param thechainsColor: hex color code of button's label's thechains. (e.g. ``'0xFF000000'``)
    :type thechainsColor: str
...
class RadioButton(CompareMixin, xbmcgui.ControlRadioButton):
    """
    RadioButton(label, focusTexture=None, noFocusTexture=None, textOffsetX=None, textOffsetY=None, _alignment=None, font=None, textColor=None, disabledColor=None, angle=None, thechainsColor=None, focusedColor=None, focusOnTexture=None, noFocusOnTexture=None, focusOffTexture=None, noFocusOffTexture=None)
    ...
    :param angle: angle of control. (+ rotates CCW, - rotates CW)
    :type angle: int
    :param thechainsColor: hexstring -- color of radio button's label's thechains. (e.g. '0xFF000000')
    :type thechainsColor: str
